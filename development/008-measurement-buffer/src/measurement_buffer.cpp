...
static bool saveMetadata()
{
    ...
    Serial.printf("saveMetadata written bytes: %u\n", writtenBytes);
    Serial.printf("sizeof(metaData): %u\n", sizeof(metaData));
...
static bool loadMetadata()
{
    ...
    Serial.printf("loadMetadata read bytes: %u\n", readBytes);
    Serial.printf("sizeof(metaData): %u\n", sizeof(metaData));
    Serial.printf("Magic read: 0x%08lX\n", metaData.magic);
    Serial.printf("Magic exp : 0x%08lX\n", BUFFER_METADATA_MAGIC);
...
bool initBuffer()
{
    if (loadMetadata())
    { 
        Serial.println("Measurement buffer metadata loaded.");
        Serial.printf("ReadIndex : %u\n", metaData.readIndex);
        Serial.printf("WriteIndex: %u\n", metaData.writeIndex);
        Serial.printf("Count     : %u\n", metaData.recordCount);
        Serial.printf("Overflow  : %lu\n", metaData.overflowCounter);
